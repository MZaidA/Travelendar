        ...
        <div id="mainPanel">
            ...
            <div class="form">
                <form action="editScheduledTransportation.jsp">
                    ...
                    <input type="text" id="mScheduledTransportationName" name="scheduledTransportationName" placeholder="Transportation Name..." required value="<%=sch.getScheduledTransportationName()%>">
