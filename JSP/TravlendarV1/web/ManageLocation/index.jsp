...
<html>
    <head>
        ...
        <title>Manage Location - Travlendar</title>
        <%
            ...
            <table align="center">
                ...
                <c:forEach items="${locations}" var="item" varStatus="loop">
                    <tr>
                        ...
                        <td>
                            <a href="editLocationForm.jsp?locationId=${item.locationId}" class="button1">Update</a>
                            <a href="deleteLocation.jsp?locationId=${item.locationId}" class="button1">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
