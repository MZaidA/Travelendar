...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2017 at 01:09 PM
...
CREATE TABLE `event` (
  ...
  `ARRIVAL_AT_LOCATION_DATE` date DEFAULT NULL,
  `ARRIVAL_AT_LOCATION_TIME` time DEFAULT NULL,
  `EVENT_FINISHED_DATE` date DEFAULT NULL,
  `EVENT_FINISHED_TIME` time DEFAULT NULL,
  `DEPARTURE_TO_LOCATION_DATE` date DEFAULT NULL,
  `DEPARTURE_TO_LOCATION_TIME` time DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
